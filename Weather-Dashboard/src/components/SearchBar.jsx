  ...
  return (
    <div className='flex justify-around p-5 mx-auto'>
      ...
      <div className='flex gap-3 items-center border w-40 h-13 p-2 rounded-md '>
        <img src="./public/icons/weather-app.png" alt="" className='w-10 sm:w-8'/>
        <h1 className='text-xl text-white  font-bold sm:text-lg'>My Weather</h1>
      </div>
      ...
      <button className='w-14 h-14 bg-black rounded-full  border-2 border-gray-600  items-center flex justify-center hover:bg-white duration-200 delay-75'><img src="./public/icons/light-mode.png"  alt="" className='w-9'  /></button>
